-- ============================================================================
-- QHUB R15.5 — 15 POST-PATCH RUNTIME VERIFIER VERIFY (READ-ONLY, SINGLE SNAPSHOT)
--
-- Run this file IN FULL, as one unit, immediately after
-- 14_LIVE_RUNTIME_VERIFIER_TRIGGER_ACL_PATCH.sql. It performs NO writes.
--
...
--     authority: the statement still returns R15_5_VERIFIER_NOT_READY.
--
...
--     returns R15_5_VERIFIER_NOT_READY.
--
...
--     verifier is NOT invoked and final_status is R15_5_VERIFIER_NOT_READY.
--
  ...
  CASE
    WHEN authority_ok
     ...
     AND product_failed_count = '0'
      THEN 'R15_5_VERIFIER_READY'
    ELSE 'R15_5_VERIFIER_NOT_READY'
  END                                            AS final_status
FROM product;
