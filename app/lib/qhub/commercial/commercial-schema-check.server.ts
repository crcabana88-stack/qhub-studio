 ...
 * version 2026-07-30.commercial-launch-r6, ready=true, and an empty failed[]; it fails
...
export const EXPECTED_COMMERCIAL_SCHEMA_VERSION = '2026-07-30.commercial-launch-r6';
