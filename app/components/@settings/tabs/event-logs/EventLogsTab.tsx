...
export function EventLogsTab() {
  ...
  const exportAsPDF = () => {
    try {
      ...
      // Add subtitle with QHUB Studio
      doc.setFontSize(12);
      doc.setFont('helvetica', 'normal');
      doc.text('QHUB Studio - AI Development Platform', margin, 45);
      yPos = 70;
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        // Add footer text
        doc.text('Generated by QHUB Studio', margin, doc.internal.pageSize.getHeight() - 10);
